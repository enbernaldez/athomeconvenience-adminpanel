...
document.getElementById('backArrowAccepted').addEventListener('click', function(){
    location.replace('http://127.0.0.1:5501/html/acceptedList.html');
})
document.getElementById('accepted-service-btn').addEventListener('click', function(){
    location.replace('http://127.0.0.1:5501/html/landingPage.html');
})
document.getElementById('accepted-customer-btn').addEventListener('click', function(){
